...
void interfaz::establecerVecesSimulacion(int n){
  nVecesSimulacion = n;
}

void interfaz::establecerTiempoTotal(int n){
  tiempoTotal = n;
}

void interfaz::establecerQuantum(int q){
  quantum = q;
}

void interfaz::establecerDistribucion(bool e){
  distribucionExponencial = e;
}

int interfaz::obtenerVecesSimulacion(){
  return nVecesSimulacion;
}

int interfaz::obtenerTiempoTotal(){
  return tiempoTotal;
}

int interfaz::obtenerQuantum(){
  return quantum;
}

bool interfaz::obtenerDistribucion(){
